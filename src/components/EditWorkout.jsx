...
const EditWorkout = ({
  ...
  const onSubmit = async (data) => {
    ...
    if (data.exercises.length === 0) {
      alert(
        "A workout needs at least one exercise. Delete the workout instead if you wish to remove it entirely.",
      );
      return;
    }
    ...
    if (data.exercises.length > workout.exercises.length) {
      ...
      resolvedExerciseData = await Promise.all(
  ...
  return (
    <>
      ...
      <div className="edit-modal-overlay">
        <form
          className="workout-form edit-workout-form"
              ...
              <div className="field-card" key={exercise.id}>
                ...
                {isExistingExercise ? (
                  <input
                    ...
                    type="text"
                    className="edit-exercise-type-input"
                    readOnly
