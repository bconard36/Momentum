        ...
        <div id="inputs" className="metrics">
          <form className="calculator-form" onSubmit={handleSubmit(onSubmit)}>
            <div className="metrics">
              ...
              {errors.height && (
                <div className="invalid-input-banner">
                ...
                {...register("height", {
                  ...
                  validate: {
                    inRange: (value) =>
                      ...
                      "Height must be between 53 and 84 inches",
                    isNumber: (value) =>
                      !isNaN(value) || "Height must be a number",
                  },
                })}
              />
                ...
                {...register("weight", {
                  ...
                  validate: {
                    inRange: (value) =>
                      ...
                      "Weight must be between 50 and 1000 pounds (lbs)",
                    isNumber: (value) =>
                      !isNaN(value) || "Weight must be a number",
                  },
                })}
              />
              ...
              <input
                ...
                {...register("gender", {
                  ...
                  validate: (value) =>
                    ...
                    "Gender must be M/m for Male or F/f for Female",
                })}
              />
            </div>
            ...
            <div className="activity" id="activity">
              <label htmlFor="activityLevel">
                Please choose a number corresponding to your activity levels:
              </label>
              ...
              <select
                ...
                {...register("activityLevel", {
                  ...
                  validate: (value) =>
                    ...
                    "Activity Level must be 1-5. Please choose an option from the list.",
                })}
              >
