    ...
    return ( 
        ...
        {/* Change workout-header calls to log-header/something similar */}
            ...
            {savedWorkouts?.length > 0 && (
                <>
                {deleteConfirm && (
                    <div className="workout-modal-overlay success-overlay" onClick={() => setDeleteConfirm(false)}>
                        <p className="success-message">Your workout has been deleted.</p>
                        <div className="success-return-container">
                            <button className="secondary-button success-redirect" type="button" onClick={() => setDeleteConfirm(false)}>
                                Back to Workout Log
                            </button>                                
                        </div>
                    </div>
